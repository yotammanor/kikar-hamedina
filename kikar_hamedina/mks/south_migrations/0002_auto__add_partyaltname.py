...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartyAltname'
        db.create_table(u'mks_partyaltname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Party'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'mks', ['PartyAltname'])


    def backwards(self, orm):
        # Deleting model 'PartyAltname'
        db.delete_table(u'mks_partyaltname')
    ...
    models = {
        ...
        u'mks.partyaltname': {
            'Meta': {'object_name': 'PartyAltname'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mks.Party']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
