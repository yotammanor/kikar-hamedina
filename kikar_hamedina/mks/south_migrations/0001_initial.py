...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'mks_correlation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('m1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='m1', to=orm['mks.Member'])),
            ('m2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='m2', to=orm['mks.Member'])),
            ('score', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('normalized_score', self.gf('django.db.models.fields.FloatField')(null=True)),
            ('not_same_party', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'mks', ['Correlation'])

        # Adding model 'CoalitionMembership'
        db.create_table(u'mks_coalitionmembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'mks', ['CoalitionMembership'])

        # Adding model 'Knesset'
        db.create_table(u'mks_knesset', (
            ('number', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'mks', ['Knesset'])

        # Adding model 'Party'
        db.create_table(u'mks_party', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('is_coalition', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('number_of_members', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('number_of_seats', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('knesset', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='parties', null=True, to=orm['mks.Knesset'])),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal(u'mks', ['Party'])

        # Adding unique constraint on 'Party', fields ['knesset', 'name']
        db.create_unique(u'mks_party', ['knesset_id', 'name'])

        # Adding model 'Membership'
        db.create_table(u'mks_membership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Member'])),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Party'])),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('position', self.gf('django.db.models.fields.PositiveIntegerField')(default=999, blank=True)),
        ))
        db.send_create_signal(u'mks', ['Membership'])

        # Adding model 'MemberAltname'
        db.create_table(u'mks_memberaltname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Member'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'mks', ['MemberAltname'])

        # Adding model 'Member'
        db.create_table(u'mks_member', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('current_party', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='members', null=True, to=orm['mks.Party'])),
            ('current_position', self.gf('django.db.models.fields.PositiveIntegerField')(default=999, blank=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ...
            ('family_status', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('number_of_children', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('year_of_aliyah', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('is_current', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True)),
            ('blog', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['planet.Blog'], unique=True, null=True, blank=True)),
            ('place_of_residence', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('area_of_residence', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('place_of_residence_lat', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
            ('place_of_residence_lon', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True)),
            ('residence_centrality', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('residence_economy', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, blank=True)),
            ('current_role_descriptions', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('bills_stats_proposed', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bills_stats_pre', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bills_stats_first', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bills_stats_approved', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('average_weekly_presence_hours', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('average_monthly_committee_presence', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('backlinks_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'mks', ['Member'])

        # Adding model 'WeeklyPresence'
        db.create_table(u'mks_weeklypresence', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Member'])),
            ('date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('hours', self.gf('django.db.models.fields.FloatField')(blank=True)),
        ))
        db.send_create_signal(u'mks', ['WeeklyPresence'])


    def backwards(self, orm):
        # Removing unique constraint on 'Party', fields ['knesset', 'name']
        db.delete_unique(u'mks_party', ['knesset_id', 'name'])

        # Deleting model 'Correlation'
        db.delete_table(u'mks_correlation')

        # Deleting model 'CoalitionMembership'
        db.delete_table(u'mks_coalitionmembership')

        # Deleting model 'Knesset'
        db.delete_table(u'mks_knesset')

        # Deleting model 'Party'
        db.delete_table(u'mks_party')

        # Deleting model 'Membership'
        db.delete_table(u'mks_membership')

        # Deleting model 'MemberAltname'
        db.delete_table(u'mks_memberaltname')

        # Deleting model 'Member'
        db.delete_table(u'mks_member')

        # Deleting model 'WeeklyPresence'
        db.delete_table(u'mks_weeklypresence')
