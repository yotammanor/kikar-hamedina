...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseExecutor.polymorphic_ctype'
        db.add_column(u'updater_baseexecutor', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_updater.baseexecutor_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseExecutor.polymorphic_ctype'
        db.delete_column(u'updater_baseexecutor', 'polymorphic_ctype_id')
