...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LikesRule'
        db.create_table(u'updater_likesrule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_updater.likesrule_set', null=True, to=orm['contenttypes.ContentType'])),
            ('last_time_analysed', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'updater', ['LikesRule'])

        # Adding M2M table for field executors on 'LikesRule'
        m2m_table_name = db.shorten_name(u'updater_likesrule_executors')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('likesrule', models.ForeignKey(orm[u'updater.likesrule'], null=False)),
            ('baseexecutor', models.ForeignKey(orm[u'updater.baseexecutor'], null=False))
        ))
        db.create_unique(m2m_table_name, ['likesrule_id', 'baseexecutor_id'])


    def backwards(self, orm):
        # Deleting model 'LikesRule'
        db.delete_table(u'updater_likesrule')

        # Removing M2M table for field executors on 'LikesRule'
        db.delete_table(db.shorten_name(u'updater_likesrule_executors'))
