...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ElectedKnesset'
        db.create_table(u'polyorg_electedknesset', (
            ('number', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('start_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('end_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('election_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'polyorg', ['ElectedKnesset'])

        # Deleting field 'CandidateList.party'
        db.delete_column(u'polyorg_candidatelist', 'party_id')

        # Adding field 'CandidateList.knesset'
        db.add_column(u'polyorg_candidatelist', 'knesset',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='candidate_lists', null=True, to=orm['polyorg.ElectedKnesset']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ElectedKnesset'
        db.delete_table(u'polyorg_electedknesset')

        # Adding field 'CandidateList.party'
        db.add_column(u'polyorg_candidatelist', 'party',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Party'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CandidateList.knesset'
        db.delete_column(u'polyorg_candidatelist', 'knesset_id')
    ...
    models = {
        ...
        u'polyorg.candidatealtname': {
            'Meta': {'object_name': 'CandidateAltname'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['polyorg.Candidate']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        u'polyorg.candidatelist': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'img_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'knesset': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'candidate_lists'", 'null': 'True', 'to': u"orm['polyorg.ElectedKnesset']"}),
        ...
        u'polyorg.candidatelistaltname': {
            'Meta': {'object_name': 'CandidateListAltname'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['polyorg.CandidateList']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
        u'polyorg.electedknesset': {
            'Meta': {'object_name': 'ElectedKnesset'},
            'election_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'end_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'start_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'})
        },
