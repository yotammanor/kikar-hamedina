...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CandidateList.number_of_seats'
        db.add_column(u'polyorg_candidatelist', 'number_of_seats',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Candidate.is_current'
        db.add_column(u'polyorg_candidate', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CandidateList.number_of_seats'
        db.delete_column(u'polyorg_candidatelist', 'number_of_seats')

        # Deleting field 'Candidate.is_current'
        db.delete_column(u'polyorg_candidate', 'is_current')
