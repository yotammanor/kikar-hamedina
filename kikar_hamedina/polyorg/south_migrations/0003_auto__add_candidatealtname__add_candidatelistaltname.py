...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CandidateAltname'
        db.create_table(u'polyorg_candidatealtname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polyorg.Candidate'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'polyorg', ['CandidateAltname'])

        # Adding model 'CandidateListAltname'
        db.create_table(u'polyorg_candidatelistaltname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['polyorg.CandidateList'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'polyorg', ['CandidateListAltname'])


    def backwards(self, orm):
        # Deleting model 'CandidateAltname'
        db.delete_table(u'polyorg_candidatealtname')

        # Deleting model 'CandidateListAltname'
        db.delete_table(u'polyorg_candidatelistaltname')
    ...
    models = {
        ...
        u'polyorg.candidatelist': {
            ...
            'number_of_seats': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'party': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mks.Party']", 'null': 'True', 'blank': 'True'}),
