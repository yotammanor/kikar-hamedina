...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CandidateList.wikipedia_page'
        db.alter_column(u'polyorg_candidatelist', 'wikipedia_page', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))

    def backwards(self, orm):

        # Changing field 'CandidateList.wikipedia_page'
        db.alter_column(u'polyorg_candidatelist', 'wikipedia_page', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
    ...
    models = {
        ...
        u'polyorg.candidatelist': {
            ...
            'wikipedia_page': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
