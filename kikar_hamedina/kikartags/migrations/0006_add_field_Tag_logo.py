...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.logo'
        db.add_column(u'kikartags_tag', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.logo'
        db.delete_column(u'kikartags_tag', 'logo')
    ...
    models = {
        ...
        u'kikartags.taggeditem': {
            ...
            'date_of_tagging': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 23, 0, 0)', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
