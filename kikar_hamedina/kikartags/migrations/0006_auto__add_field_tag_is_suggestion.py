...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.is_suggestion'
        db.add_column(u'kikartags_tag', 'is_suggestion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.is_suggestion'
        db.delete_column(u'kikartags_tag', 'is_suggestion')
    ...
    models = {
        ...
        u'kikartags.taggeditem': {
            ...
            'date_of_tagging': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 24, 0, 0)', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
