...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facebook_Status.comment_count'
        db.alter_column(u'facebook_feeds_facebook_status', 'comment_count', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Facebook_Status.like_count'
        db.alter_column(u'facebook_feeds_facebook_status', 'like_count', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Facebook_Status.share_count'
        db.alter_column(u'facebook_feeds_facebook_status', 'share_count', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Facebook_Status.comment_count'
        db.alter_column(u'facebook_feeds_facebook_status', 'comment_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Facebook_Status.like_count'
        db.alter_column(u'facebook_feeds_facebook_status', 'like_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Facebook_Status.share_count'
        db.alter_column(u'facebook_feeds_facebook_status', 'share_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 25, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 25, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 24, 0, 0)'}),
