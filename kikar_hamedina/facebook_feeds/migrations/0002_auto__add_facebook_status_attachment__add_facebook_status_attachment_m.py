...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'facebook_feeds_facebook_status_attachment', (
            ...
            ('caption', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True)),
        ...
        db.create_table(u'facebook_feeds_facebook_status_attachment_media', (
            ...
            ('picture', self.gf('django.db.models.fields.URLField')(max_length=512, null=True)),
            ('thumbnail', self.gf('django.db.models.fields.URLField')(max_length=512, null=True)),
    ...
    models = {
        ...
        u'facebook_feeds.facebook_status_attachment': {
            ...
            'caption': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
        ...
        u'facebook_feeds.facebook_status_attachment_media': {
            'Meta': {'object_name': 'Facebook_Status_Attachment_Media'},
