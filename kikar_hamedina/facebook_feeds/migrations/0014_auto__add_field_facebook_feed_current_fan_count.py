...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Deleting field 'Facebook_Feed.current_fan_count'
        db.delete_column(u'facebook_feeds_facebook_feed', 'current_fan_count')
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 26, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 26, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 25, 0, 0)'}),
