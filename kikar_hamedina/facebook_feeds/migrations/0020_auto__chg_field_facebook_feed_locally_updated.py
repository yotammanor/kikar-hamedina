...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facebook_Feed.locally_updated'
        db.alter_column(u'facebook_feeds_facebook_feed', 'locally_updated', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Facebook_Feed.locally_updated'
        db.alter_column(u'facebook_feeds_facebook_feed', 'locally_updated', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 3, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 12, 3, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 2, 1, 0, 0)'}),
