...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Facebook_Status.story'
        db.add_column(u'facebook_feeds_facebook_status', 'story',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Facebook_Status.story'
        db.delete_column(u'facebook_feeds_facebook_status', 'story')
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 31, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 31, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 30, 0, 0)'}),
