...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facebook_Status_Attachment.link'
        db.alter_column(u'facebook_feeds_facebook_status_attachment', 'link', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Facebook_Status_Attachment_Media.picture'
        db.alter_column(u'facebook_feeds_facebook_status_attachment_media', 'picture', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Facebook_Status_Attachment_Media.link'
        db.alter_column(u'facebook_feeds_facebook_status_attachment_media', 'link', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Facebook_Status_Attachment_Media.thumbnail'
        db.alter_column(u'facebook_feeds_facebook_status_attachment_media', 'thumbnail', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Facebook_Status_Attachment.link'
        db.alter_column(u'facebook_feeds_facebook_status_attachment', 'link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))

        # Changing field 'Facebook_Status_Attachment_Media.picture'
        db.alter_column(u'facebook_feeds_facebook_status_attachment_media', 'picture', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))

        # Changing field 'Facebook_Status_Attachment_Media.link'
        db.alter_column(u'facebook_feeds_facebook_status_attachment_media', 'link', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))

        # Changing field 'Facebook_Status_Attachment_Media.thumbnail'
        db.alter_column(u'facebook_feeds_facebook_status_attachment_media', 'thumbnail', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 1, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 30, 0, 0)'}),
