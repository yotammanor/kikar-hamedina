...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facebook_Status_Attachment.type'
        db.add_column(u'facebook_feeds_facebook_status_attachment', 'type',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True),
                      keep_default=False)

        # Adding field 'Facebook_Status_Attachment.picture'
        db.add_column(u'facebook_feeds_facebook_status_attachment', 'picture',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


        # Changing field 'Facebook_Status_Attachment.link'
        db.alter_column(u'facebook_feeds_facebook_status_attachment', 'link', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):
        # Deleting field 'Facebook_Status_Attachment.type'
        db.delete_column(u'facebook_feeds_facebook_status_attachment', 'type')

        # Deleting field 'Facebook_Status_Attachment.picture'
        db.delete_column(u'facebook_feeds_facebook_status_attachment', 'picture')
