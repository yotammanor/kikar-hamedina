...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Facebook_Feed.picture_square'
        db.add_column(u'facebook_feeds_facebook_feed', 'picture_square',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)

        # Adding field 'Facebook_Feed.picture_large'
        db.add_column(u'facebook_feeds_facebook_feed', 'picture_large',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Facebook_Feed.picture_square'
        db.delete_column(u'facebook_feeds_facebook_feed', 'picture_square')

        # Deleting field 'Facebook_Feed.picture_large'
        db.delete_column(u'facebook_feeds_facebook_feed', 'picture_large')
    ...
    models = {
        ...
        u'facebook_feeds.facebook_feed': {
            ...
            'picture_large': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'}),
            'picture_square': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'}),
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 9, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 9, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 8, 0, 0)'}),
