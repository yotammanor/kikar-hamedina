...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facebook_Status.is_comment'
        db.add_column(u'facebook_feeds_facebook_status', 'is_comment',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facebook_Status.is_comment'
        db.delete_column(u'facebook_feeds_facebook_status', 'is_comment')
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 9, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 9, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 8, 0, 0)'}),
