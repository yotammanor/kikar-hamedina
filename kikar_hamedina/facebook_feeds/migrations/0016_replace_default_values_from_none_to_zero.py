...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Change NULLs to 0s in count fields
        for status in orm.Facebook_Status.objects.filter(like_count__isnull=True):
            status.like_count = 0
            status.save()
        for status in orm.Facebook_Status.objects.filter(comment_count__isnull=True):
            status.comment_count = 0
            status.save()
        for status in orm.Facebook_Status.objects.filter(share_count__isnull=True):
    ...
    models = {
        ...
        u'facebook_feeds.facebook_status': {
            ...
            'comment_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            ...
            'like_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'published': ('django.db.models.fields.DateTimeField', [], {}),
            'share_count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
