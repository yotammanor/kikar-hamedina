...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Facebook_Status.story'
        db.alter_column(u'facebook_feeds_facebook_status', 'story', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Facebook_Status.story'
        db.alter_column(u'facebook_feeds_facebook_status', 'story', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))
