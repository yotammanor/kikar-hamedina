...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facebook_Feed.is_current'
        db.add_column(u'facebook_feeds_facebook_feed', 'is_current',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facebook_Feed.is_current'
        db.delete_column(u'facebook_feeds_facebook_feed', 'is_current')
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 10, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 9, 0, 0)'}),
