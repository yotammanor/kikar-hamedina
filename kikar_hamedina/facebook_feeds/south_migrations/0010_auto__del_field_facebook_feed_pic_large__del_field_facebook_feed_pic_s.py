...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'facebook_feeds_facebook_feed', 'pic_large')

        # Deleting field 'Facebook_Feed.pic_square'
        db.delete_column(u'facebook_feeds_facebook_feed', 'pic_square')

        # Deleting field 'Facebook_Feed.page_url'
        db.delete_column(u'facebook_feeds_facebook_feed', 'page_url')

        # Adding field 'Facebook_Feed.link'
        db.add_column(u'facebook_feeds_facebook_feed', 'link',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)

        # Adding field 'Facebook_Feed.picture'
        db.add_column(u'facebook_feeds_facebook_feed', 'picture',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'facebook_feeds_facebook_feed', 'pic_large',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)

        # Adding field 'Facebook_Feed.pic_square'
        db.add_column(u'facebook_feeds_facebook_feed', 'pic_square',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)

        # Adding field 'Facebook_Feed.page_url'
        db.add_column(u'facebook_feeds_facebook_feed', 'page_url',
                      self.gf('django.db.models.fields.URLField')(max_length=2000, null=True),
                      keep_default=False)

        # Deleting field 'Facebook_Feed.link'
        db.delete_column(u'facebook_feeds_facebook_feed', 'link')

        # Deleting field 'Facebook_Feed.picture'
        db.delete_column(u'facebook_feeds_facebook_feed', 'picture')
    ...
    models = {
        ...
        u'facebook_feeds.facebook_feed': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'link': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'}),
            ...
            'picture': ('django.db.models.fields.URLField', [], {'max_length': '2000', 'null': 'True'}),
        ...
        u'facebook_feeds.facebook_status': {
            ...
            'story_tags': ('django.db.models.fields.TextField', [], {'null': 'True'}),
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 18, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 17, 0, 0)'}),
