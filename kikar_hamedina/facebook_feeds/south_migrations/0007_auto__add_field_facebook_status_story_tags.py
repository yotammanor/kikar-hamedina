...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facebook_Status.story_tags'
        db.add_column(u'facebook_feeds_facebook_status', 'story_tags',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facebook_Status.story_tags'
        db.delete_column(u'facebook_feeds_facebook_status', 'story_tags')
