...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facebook_Status.is_deleted'
        db.add_column(u'facebook_feeds_facebook_status', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facebook_Status.is_deleted'
        db.delete_column(u'facebook_feeds_facebook_status', 'is_deleted')
    ...
    models = {
        ...
        u'facebook_feeds.feed_popularity': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 6, 0, 0)'}),
        ...
        u'facebook_feeds.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 6, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 11, 5, 0, 0)'}),
