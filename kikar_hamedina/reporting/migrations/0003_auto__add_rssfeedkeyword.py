...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RSSFeedKeyWord'
        db.create_table(u'reporting_rssfeedkeyword', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='words_in_rss_feed', to=orm['auth.User'])),
            ('keyword', self.gf('django.db.models.fields.CharField')(unique=True, max_length=64)),
        ))
        db.send_create_signal(u'reporting', ['RSSFeedKeyWord'])


    def backwards(self, orm):
        # Deleting model 'RSSFeedKeyWord'
        db.delete_table(u'reporting_rssfeedkeyword')
