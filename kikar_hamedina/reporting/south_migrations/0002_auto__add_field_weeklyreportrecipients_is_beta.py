...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WeeklyReportRecipients.is_beta'
        db.add_column(u'reporting_weeklyreportrecipients', 'is_beta',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WeeklyReportRecipients.is_beta'
        db.delete_column(u'reporting_weeklyreportrecipients', 'is_beta')
