...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WeeklyReportRecipients'
        db.create_table(u'reporting_weeklyreportrecipients', (
        ...
        db.send_create_signal(u'reporting', ['WeeklyReportRecipients'])


    def backwards(self, orm):
        # Deleting model 'WeeklyReportRecipients'
        db.delete_table(u'reporting_weeklyreportrecipients')
