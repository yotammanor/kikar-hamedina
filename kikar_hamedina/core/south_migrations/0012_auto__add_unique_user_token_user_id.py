...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'User_Token', fields ['user_id']
        db.create_unique(u'core_user_token', ['user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'User_Token', fields ['user_id']
        db.delete_unique(u'core_user_token', ['user_id'])
