...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User_Token.date_of_expiration'
        db.add_column(u'core_user_token', 'date_of_expiration',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 25, 0, 0)),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'User_Token.date_of_expiration'
        db.delete_column(u'core_user_token', 'date_of_expiration')
    ...
    models = {
        ...
        u'core.user_token': {
            ...
            'date_of_creation': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 26, 0, 0)'}),
            'date_of_expiration': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 25, 0, 0)'}),
