...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Role'
        db.create_table(u'persons_role', (
            ...
            ('org', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='roles', to=orm['persons.Person'])),
        ))
        db.send_create_signal(u'persons', ['Role'])

        # Adding model 'PersonAlias'
        db.create_table(u'persons_personalias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='aliases', to=orm['persons.Person'])),
        ))
        db.send_create_signal(u'persons', ['PersonAlias'])

        # Adding model 'Title'
        db.create_table(u'persons_title', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'persons', ['Title'])
        ...
        m2m_table_name = db.shorten_name(u'persons_person_titles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('person', models.ForeignKey(orm[u'persons.person'], null=False)),
            ('title', models.ForeignKey(orm[u'persons.title'], null=False))
        ))
        db.create_unique(m2m_table_name, ['person_id', 'title_id'])

        # Adding model 'ProcessedProtocolPart'
        db.create_table(u'persons_processedprotocolpart', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('protocol_part_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'persons', ['ProcessedProtocolPart'])


    def backwards(self, orm):
        # Deleting model 'Role'
        db.delete_table(u'persons_role')

        # Deleting model 'PersonAlias'
        db.delete_table(u'persons_personalias')

        # Deleting model 'Title'
        db.delete_table(u'persons_title')

        # Deleting model 'Person'
        db.delete_table(u'persons_person')

        # Removing M2M table for field titles on 'Person'
        db.delete_table(db.shorten_name(u'persons_person_titles'))

        # Deleting model 'ProcessedProtocolPart'
        db.delete_table(u'persons_processedprotocolpart')
