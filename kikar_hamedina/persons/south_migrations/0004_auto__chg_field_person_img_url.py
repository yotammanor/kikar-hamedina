...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'persons_person', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Person.img_url'
        db.alter_column(u'persons_person', 'img_url', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
