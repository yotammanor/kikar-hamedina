...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PersonAltname'
        db.create_table(u'persons_personaltname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.Person'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'persons', ['PersonAltname'])


    def backwards(self, orm):
        # Deleting model 'PersonAltname'
        db.delete_table(u'persons_personaltname')
